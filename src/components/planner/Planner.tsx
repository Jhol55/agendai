...
const CalendarContent: React.FC<CalendarContentProps> = ({ ...props }) => {
  ...
  return (appointments &&
    <div
      className="flex flex-col border border-l-0 border-b-0 rounded-md rounded-l-none rounded-br-none overflow-hidden md:h-[93vh] h-[93vh] leading-relaxed shadow-sm"
    >
