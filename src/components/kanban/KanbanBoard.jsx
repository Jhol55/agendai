...
import { useRouter, useSearchParams } from 'next/navigation'; // Importações para Next.js
...
function KanbanBoard() {
  ...
  // Next.js equivalents for navigation and search params
  ...
  const handleAttributeChange = (e) => {
    ...
    currentSearchParams.set('kbw', newKey);
