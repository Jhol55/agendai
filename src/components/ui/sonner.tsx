    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          closeButton: "group-[.toast]:bg-white dark:group-[.toast]:bg-background dark:group-[.toast]:border-neutral-800 group-[.toast]:text-muted-foreground"
        },
      }}
      icons={{
        success: <CheckCircle className="h-4 w-4 text-green-500" />,
        info: <Info className="h-4 w-4 text-skyblue" />,
