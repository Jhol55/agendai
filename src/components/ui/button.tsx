  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input dark:border-neutral-700/60 bg-neutral-200 border-neutral-400/30 dark:bg-neutral-800 dark:hover:bg-neutral-700 hover:bg-neutral-300/90 !text-neutral-700 !hover:text-neutral-900 dark:hover:text-neutral-200 dark:text-neutral-200",
        secondary:
